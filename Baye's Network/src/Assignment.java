...
public class Assignment extends LinkedHashMap<RandomVariable,Object> {
    ...
    public static void main (String [] args){
    	Domain truthTable = new Domain(true,false);
    	RandomVariable alarm = new RandomVariable("Alarm", truthTable);
    	RandomVariable burglar = new RandomVariable("Burglar", truthTable);
    	Assignment testAss= new Assignment();
    	testAss.set(burglar, false);
    	testAss.set(alarm, true);
    	System.out.println(testAss.toString());
    }
}
