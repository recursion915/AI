...
public class Distribution extends LinkedHashMap<Object,Double> {
    ...
    public static void main(String [] args){
    	RandomVariable rv= new RandomVariable("A");
    	rv.setDomain(new Domain(Boolean.TRUE,Boolean.FALSE));
    	Distribution distribution=new Distribution(rv);
    	distribution.put(Boolean.TRUE,0.00059224);
    	distribution.put(Boolean.FALSE,0.0014919);
    	distribution.put("wTG",0.2312313);
